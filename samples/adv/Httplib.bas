...
' for macOS and Linux
' delete LF_FLAGS and -include windows.h
...
Sub Main
	...
	svr.Get( "/hi", Sub( Const ByRef req As Request, ByRef res As Response )
	...
	' compile and running this sample, use bellowing urls to see the result
